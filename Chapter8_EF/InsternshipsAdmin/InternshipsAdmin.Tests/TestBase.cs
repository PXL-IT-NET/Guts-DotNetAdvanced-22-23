...
namespace InternshipsAdmin.Tests
{
    public abstract class TestBase
    {
        ...
        protected void AssertHasPublicProperty(Type type, string propertyName)
        {
            PropertyInfo? property = type.GetProperty(propertyName);
            Assert.That(property, Is.Not.Null, $"No property '{propertyName}' was found");
        }

        protected void AssertHasPublicPropertyOfType(Type type, string propertyName, Type propertyType)
        {
            PropertyInfo? property = type.GetProperty(propertyName);
            Assert.That(property, Is.Not.Null, $"No property '{propertyName}' was found");
